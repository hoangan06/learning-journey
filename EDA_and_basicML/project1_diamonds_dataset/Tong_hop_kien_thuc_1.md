...
1. **Tầng 0: Đóng khung** (trước khi nhìn vào số liệu)
    ...
    - Trả lời: Bối cảnh và bảng mô tả cột.
...
4. **Tầng 3: Phân tích riêng từng biến** (univariate)
    ...
    - *Kiến thức bổ sung về lệch phải:* Lệch phải là triệu chứng, quan hệ nhân/lũy thừa là nguyên nhân, log là thuốc. Log biến phép nhân thành phép cộng, biến tỉ lệ thành khoảng cách đều.
...
### **Những phân tích quan trọng hay bị sót:**
...
- Outlier là lỗi hay cực trị thật.
