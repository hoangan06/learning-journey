...
## Kỹ năng thể hiện
Python, pandas, scikit-learn, xgboost, TensorFlow/Keras, EDA, phân tích chuỗi thời gian, feature engineering & target encoding, deep learning / CNN (thị giác máy tính), chống rò rỉ dữ liệu, đánh giá mô hình, Git.
